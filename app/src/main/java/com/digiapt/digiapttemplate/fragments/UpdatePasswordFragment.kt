...
import kotlinx.android.synthetic.main._fragment_update_password.*
...
class UpdatePasswordFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout._fragment_update_password, container, false)
    }
                ...
                user.updatePassword(password)
                    .addOnCompleteListener { task ->
                        if(task.isSuccessful){
                            val action =
                                UpdatePasswordFragmentDirections.actionPasswordUpdated()
